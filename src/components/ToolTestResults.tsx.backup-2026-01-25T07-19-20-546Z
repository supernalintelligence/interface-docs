...
import { ToolTester, ToolTestSuite } from '../lib/ToolTester';
...
interface ToolTestResultsProps {
  onTestComplete?: (summary: TestSummary) => void;
}
              ...
              {expandedSuites.has(suite.toolName) && (
                <div className="border-t border-gray-200">
                  {suite.results.map((result) => (
                    <div key={result.testCase.name} className="p-4 border-b border-gray-100 last:border-b-0">
