          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <button 
                  onClick={() => router.push('/demo/simple')}
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><button onClick={() => router.push('/demo/simple')} className="hover:text-white">Demo</button></li>
                  <li><button onClick={() => router.push('/examples')} className="hover:text-white">Examples</button></li>
                  <li><button onClick={() => router.push('/architecture')} className="hover:text-white">Architecture</button></li>
                </ul>
              </div>
              <div>
