...
test.describe('Cache Demo', () => {
  ...
  test('Demonstrate cache hits', async ({ page }) => {
    // Execution order: Demonstrate cache hits-569 → Demonstrate cache hits-570 → Demonstrate cache hits-571 → Demonstrate cache hits-572 → Demonstrate cache hits-573 → Demonstrate cache hits-574
