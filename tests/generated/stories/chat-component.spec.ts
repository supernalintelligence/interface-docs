...
test.describe('Chat Component', () => {
  ...
  test('Chat input is enabled on page load', async ({ page }) => {
    // Execution order: Chat input is enabled on page load-151 → Chat input is enabled on page load-152
  ...
  test('Sending a message adds it to the chat', async ({ page }) => {
    // Execution order: Sending a message adds it to the chat-153 → Sending a message adds it to the chat-154 → Sending a message adds it to the chat-155 → Sending a message adds it to the chat-156
    // Given I am on Routes.demo
    await page.goto(`${Routes.demo.root}`);
    await initializeTestState(page);
  ...
  test('Multiple messages appear in sequence', async ({ page }) => {
    // Execution order: Multiple messages appear in sequence-157 → Multiple messages appear in sequence-158 → Multiple messages appear in sequence-159 → Multiple messages appear in sequence-160 → Multiple messages appear in sequence-161 → Multiple messages appear in sequence-162
    // Given I am on Routes.demo
    await page.goto(`${Routes.demo.root}`);
    await initializeTestState(page);
