---
id: comp-iso27001-078-installation-of-software-on-operational-systems
...
**Purpose**: Procedures shall be implemented to control software installation  
**ISO 27001 Control**: A.8.19  
...
Implements ISO 27001 control A.8.19 to procedures shall be implemented to control software installation. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Installation of Software on Operational Systems
  As an information security officer
  I want to implement installation of software on operational systems
  So that I can meet ISO 27001 A.8.19 requirements
